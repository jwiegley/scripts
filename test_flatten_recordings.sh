...
write_route "$snapshot_home" "GLM-5.3-Flash-oQ4e"
...
write_route "$agent_home" "GLM-5.3-Flash-oQ4e"
...
write_route "$agent_failure_home" "GLM-5.3-Flash-oQ4e"
...
write_route "$xdg_home" "GLM-5.3-Flash-oQ4e" "$xdg_config"
...
write_route "$fallback_home" "GLM-5.3-Flash-oQ4e"
...
write_route "$relative_xdg_home" "GLM-5.3-Flash-oQ4e"
...
write_route "$concurrent_home" "GLM-5.3-Flash-oQ4e"
...
write_route "$collision_home" "GLM-5.3-Flash-oQ4e"
...
for race_kind in transcript audio; do
	...
	make_home "$race_home"
	write_route "$race_home" "GLM-5.3-Flash-oQ4e"
...
for recovery_phase in \
	...
	write_route "$recovery_home" "GLM-5.3-Flash-oQ4e"
...
for publish_phase in copied linked; do
	...
	write_route "$publish_home" "GLM-5.3-Flash-oQ4e"
...
write_route "$legacy_recovery_home" "GLM-5.3-Flash-oQ4e"
...
write_route "$wrong_legacy_home" "GLM-5.3-Flash-oQ4e"
...
write_route "$fresh_legacy_home" "GLM-5.3-Flash-oQ4e"
...
write_route "$source_change_home" "GLM-5.3-Flash-oQ4e"
...
write_route "$deleted_during_home" "GLM-5.3-Flash-oQ4e"
...
write_route "$failed_replace_home" "GLM-5.3-Flash-oQ4e"
...
write_route "$crash_replace_home" "GLM-5.3-Flash-oQ4e"
...
write_route "$absent_home" "GLM-5.3-Flash-oQ4e"
...
write_route "$claimed_home" "GLM-5.3-Flash-oQ4e"
...
write_route "$mismatched_claim_home" "GLM-5.3-Flash-oQ4e"
...
write_route "$absent_fail_home" "GLM-5.3-Flash-oQ4e"
...
write_route "$retry_isolation_home" "GLM-5.3-Flash-oQ4e"
...
write_route "$duplicate_home" "GLM-5.3-Flash-oQ4e"
...
write_route "$renamed_home" "GLM-5.3-Flash-oQ4e"
...
write_route "$replacement_home" "GLM-5.3-Flash-oQ4e"
...
write_route "$restoration_home" "GLM-5.3-Flash-oQ4e"
...
write_route "$claim_collision_home" "GLM-5.3-Flash-oQ4e"
...
for foreign_phase in preexisting mid-asr; do
	...
	write_route "$foreign_home" "GLM-5.3-Flash-oQ4e"
...
write_route "$failure_home" "GLM-5.3-Flash-oQ4e"
